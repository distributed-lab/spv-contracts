...
GENERATED="${GOPATH}/src/github.com/distributed-lab/spv-contract-populator/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/distributed-lab/spv-contract-populator/docs/web_deploy"
