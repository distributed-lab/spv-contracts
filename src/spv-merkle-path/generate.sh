...
GENERATED="${GOPATH}/src/github.com/distributed-lab/spv-merkle-path/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/distributed-lab/spv-merkle-path/docs/web_deploy"
