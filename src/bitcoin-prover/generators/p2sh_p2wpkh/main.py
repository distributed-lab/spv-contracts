...
def get_config(path: str = "./generators/p2sh_p2wpkh/config.json") -> Dict:
...
def main():
    ...
    signature = currentTx.witness[INPUT_TO_SIGN].stack_items[0].item.hex()
    pub_key = currentTx.witness[INPUT_TO_SIGN].stack_items[1].item.hex()
